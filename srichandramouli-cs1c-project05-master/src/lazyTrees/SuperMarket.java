...
public class SuperMarket {
   ...
   private final LazySearchTree<Item> inventory;
   ...
   public static void main(String[] args) {
      ...
      // NOTE: Test file added by @srichandramouli
      // final String TESTFILE = "resources/extra_test.txt";
    ...
    *
    * @return Whether garbage collection was successful.
    */
